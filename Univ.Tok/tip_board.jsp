...
<body>
   ...
   <header class="masthead bg-primary">
		<div class="container d-flex align-items-center flex-column">
			<img class="masthead-avatar mb-5" src="img/tip.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0 text-white">꿀팁 공유</h1>
			<br>
			...
			<jsp:include page="board/tip_func.jsp" />
		</div>
	</header>
