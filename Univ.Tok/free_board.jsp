...
<body>
   ...
   <header class="masthead bg-primary">
		<div class="container d-flex align-items-center flex-column">
			<img class="masthead-avatar mb-5" src="img/talk.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0 text-white">자유 게시판</h1>
			<br>
			...
			<jsp:include page="board/free_func.jsp" />
		</div>
	</header>
