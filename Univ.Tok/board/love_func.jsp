...
<html lang="en">
    ...
    <body>
        ...
        <script>
            ...
            let nickForlove = localStorage.getItem("logedInfo");
            let nicklove_val = JSON.parse(nickForlove); // logedInfo의 별명 사용을 위함


            const BOARDLIST_LS = "loveboards";
            const boardListsObj = [];
            let nums = 1;
            let author = nicklove_val[2];
            let date = new Date();
            let views = 0;
