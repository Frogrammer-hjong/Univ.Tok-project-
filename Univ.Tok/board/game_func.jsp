...
<html lang="en">
    ...
    <body>
        ...
        <script>
            ...
            let nickForgame = localStorage.getItem("logedInfo");
            let nickGame_val = JSON.parse(nickForgame); // logedInfo의 별명 사용을 위함


            const BOARDLIST_LS = "gameboards";
            const boardListsObj = [];
            let nums = 1;
            let author = nickGame_val[2];
            let date = new Date();
            let views = 0;
