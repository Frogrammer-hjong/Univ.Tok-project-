...
<html lang="en">
    ...
    <body>
        ...
        <script>
            ...
            let nickFortip = localStorage.getItem("logedInfo");
            let nicktip_val = JSON.parse(nickFortip); // logedInfo의 별명 사용을 위함

            
            const BOARDLIST_LS = "tipboards";
            const boardListsObj = [];
            let nums = 1;
            let author = nicktip_val[2];
            let date = new Date();
            let views = 0;
