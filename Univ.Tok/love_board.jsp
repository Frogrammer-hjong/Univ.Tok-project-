...
<body>
   ...
   <header class="masthead bg-primary">
		<div class="container d-flex align-items-center flex-column">
			<img class="masthead-avatar mb-5" src="img/love.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0 text-white">연애 상담소</h1>
			<br>
			...
			<jsp:include page="board/love_func.jsp" />
		</div>
	</header>
