...
<body>
   ...
   <header class="masthead bg-primary">
		<div class="container d-flex align-items-center flex-column">
			<img class="masthead-avatar mb-5" src="img/game.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0 text-white">게임방</h1>
			<br>
			...
			<jsp:include page="board/game_func.jsp" />
		</div>
	</header>
